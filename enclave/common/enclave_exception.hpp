...
const std::map<core_status_code, core_status_info> core_status_map = {
    ...
    {kConsistentIncomeRequirementsNotMet,
     {"ConsistentIncomeRequirementsNotMet",
      ...
      "three months"}},
    {kAccountOwnershipInvalidInput,
     {"AccountOwnershipInvalidInput",
      "The input account number, sort code and IBAN does not match the decrypted input"}},
    {kAccountOwnershipNoMatchingAccount,
     {"AccountOwnershipNoMatchingAccount",
      "None of the associated accounts have a matching account number/sort code/IBAN"}},
    {kAccountOwnershipBACSNotSupported,
     {"AccountOwnershipBACSNotSupported",
      "An account number/sort code match was requested, but this bank does not provide that "
      "information."}},
    {kAccountOwnershipIBANNotSupported,
     {"AccountOwnershipIBANNotSupported",
      "An IBAN match was requested, but this bank does not provide that information."}},
    {kAccountOwnershipBACSAndIBANNotSupported,
     {"AccountOwnershipBACSAndIBANNotSupported",
      "This bank does not provide BACS or IBAN information, cannot perform matching."}},
