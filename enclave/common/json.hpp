 ...
 * Modified 2020-11-03 tgrbrooks
 * Removed cerr and ostream, added enclave exceptions
 */
...
void consume_ws(const string &str, size_t &offset)
{
    if (offset >= str.length())
        THROW_EXCEPTION(kJSONParseError, "Unexpectedly reached end of JSON");
    ...
    while (true)
    {
        ...
        if (str[offset] != ':')
        {
            THROW_EXCEPTION(kJSONParseError,
                            "Error: Object: Expected colon, found '" + string(1, str[offset]) +
                                "'\n");
        }
        consume_ws(str, ++offset);
        ...
        if (str[offset] == ',')
        {
            ++offset;
            if (offset >= str.length())
                THROW_EXCEPTION(kJSONParseError, "Unexpectedly reached the end of JSON");
            continue;
        }
        else if (str[offset] == '}')
        {
        ...
        {
            THROW_EXCEPTION(kJSONParseError,
                            "ERROR: Object: Expected comma, found '" + string(1, str[offset]) +
                                "'\n");
        }
    }
...
JSON parse_array(const string &str, size_t &offset)
{
    ...
    while (true)
    {
        ...
        {
            THROW_EXCEPTION(kJSONParseError,
                            "ERROR: Array: Expected ',' or ']', found '" + string(1, str[offset]) +
                                "'\n");
        }
    }
...
JSON parse_number(const string &str, size_t &offset)
{
    ...
    {
        THROW_EXCEPTION(kJSONParseError,
                        "ERROR: Number: unexpected character '" + string(1, c) + "'\n");
    }
    --offset;
...
JSON parse_next(const string &str, size_t &offset)
{
    ...
    THROW_EXCEPTION(kJSONParseError,
                    "ERROR: Parse: Unknown starting character '" + string(1, value) + "'\n");
}
} // namespace
